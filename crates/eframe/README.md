...
This fork makes many changes to egui itself but for the usage with xframe, so changes made here on egui are not adapted to eframe of this fork and instead the egui dependencies of this eframe are set to the egui upstream repository.

**So don't use this fork's eframe, use the [`eframe`](https://github.com/emilk/egui/tree/main/crates/eframe) version from the [`egui`](https://github.com/emilk/egui) repository**
